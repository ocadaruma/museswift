...
@IBDesignable public class BeamElement: ScoreElement {
...
@IBDesignable public class FlagEighthElement: ScoreElement {
...
@IBDesignable public class FlagSixteenthElement: ScoreElement {
  @IBInspectable public var invert: Bool = false
...
@IBDesignable public class BracketElement: ScoreElement {
